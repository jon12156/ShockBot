...
const reactionIdentGrandmaster = botSettings.reactionIdentGrandmaster //:seven:
const validSkillRoleStrings = ['Grandmaster', 'Master', 'Diamond', 'Platinum', 'Gold', 'Silver', 'Bronze', 'Master (pending verification)', 'Diamond (pending verification)', 'Platinum (pending verification)']
...
const messageIDForSkillSurvey = botSettings.messageIDForSkillSurvey
    //skill IDs
const roleIDGrandmaster = botSettings.roleIDGrandmaster
...
const channelIDGrandmaster = botSettings.channelIDGrandmaster
...
function removeAllSkillRoles(member) {
    ...
    member.roles.remove([roleIDGrandmaster, roleIDMaster, roleIDDiamond, roleIDPlatinum, roleIDGold, roleIDSilver, roleIDBronze, roleIDMasterPending, roleIDDiamondPending, roleIDPlatinumPending])
